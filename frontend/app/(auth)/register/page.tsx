...
export default function RegisterPage() {
  const { register: signup, isAuthenticated, isLoading, isRegistering } = useAuth();
    ...
    <div style={pageContainerStyle}>
      <div className="clay-card" style={cardOverrideStyle}>
        <div style={headerStyle}>
          ...
          <p style={subtitleStyle}>Create your restaurant workspace</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="form-group">
            ...
            />
            {errors.restaurantName && <span className="form-error">{errors.restaurantName.message}</span>}
          </div>
          ...
          >
            {isRegistering ? 'Creating workspace...' : 'Get Started'}
          </button>
        </form>
